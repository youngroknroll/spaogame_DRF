...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # 확장 필드
    username = models.CharField(max_length=50, blank=True, verbose_name="사용자명")
    ...
    gender = models.CharField(max_length=1, choices=Gender.choices, blank=True, verbose_name="성별")
